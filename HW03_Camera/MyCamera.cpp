...
void MyCamera::MoveForward(float a_fDistance)
{
	...
	//update position using forward vector
...
void MyCamera::CalculateView(void)
{
	...
	//Combine the quatYaw of quatPitch into one variable
